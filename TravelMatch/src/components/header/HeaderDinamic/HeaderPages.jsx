...
console.log(user);
  ...
  return (
    <header className={`header-container ${location.pathname === '/' ? 'transparent-header' : 'solid-header'}`}>
      <NavLink to={"/"} className="no-underline" style={{ textDecoration: "none" }}>
          ...
          <div className="user-info" onClick={toggleDropdown}>
            ...
            {showDropdown && (
              <div className="dropdown-menu">
                ...
                <button onClick={() => dispatch(actionLogout())} className="dropdown-item">
                  Cerrar sesión
                </button>
              </div>
            )}
